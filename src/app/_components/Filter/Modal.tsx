...
const Modal = ({ isOpen, onClose, contentOptions, industryOptions, selectedContent, setSelectedContent, selectedIndustry, setSelectedIndustry }: { isOpen: boolean; onClose: () => void; contentOptions: string[]; industryOptions: string[]; selectedContent: string; setSelectedContent: (content: string) => void; selectedIndustry: string; setSelectedIndustry: (industry: string) => void }) => {
