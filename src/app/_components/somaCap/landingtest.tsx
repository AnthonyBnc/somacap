...
const LandingPage: React.FC = () => {
  return (
    <div className="flex min-h-screen min-w-fit flex-col bg-gradient-to-r text-white">
      <div className="absolute -top-9 left-10 flex items-center gap-32 sm:left-auto sm:right-10 md:gap-5">
        <button className="relative mt-5 w-fit min-w-fit rounded-b-lg bg-white px-5 py-3 text-sm font-bold text-deepPurple hover:bg-gray-200 md:text-xl lg:px-5 lg:py-4">
      ...
      <BgR />
      <div className="relative flex min-h-screen flex-1 flex-col items-center justify-center p-6 lg:p-0">
